...
- **Unicom (ICLR 2023)**: 图像检索的基础性工作。
- **Partial FC (CVPR 2022 / ICCVW 2021)**: 解决了大规模人脸识别训练的效率问题。
